...
class Truck extends Vehicle {
  ...
  topSpeed: number;
  wheels: Wheel[];
  towingCapacity: number; // for the lbs as a parameter.
  ...
  constructor(
    ...
    // super is used so i can use the this.whatever properties
    super();
    ...
    // checkking wheels array making sure it has 4 elements and create 4 new default Wheel objects if it does not
    if (wheels.length !== 4) {
